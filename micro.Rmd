...
multipurpose <- function(mouse_id_antibiotic, df_vanco=df_vanco, df_taxa2=df_taxa2, lowdays=lowdays) {
  ...
  #clr data
  DATA$modelled.data <- modelled.data #raw clr data of "3" mice from the same group 
  DATA$data.gathered <- data.gathered #tidy clr data for plotting purposes 
  DATA$data.filtered <- data.filtered #CLR data for 3 mice. 
...
ctrl<-lapply(mouse_control, multipurpose,df_vanco=df_vanco, df_taxa2=df_taxa2, lowdays=lowdays)
